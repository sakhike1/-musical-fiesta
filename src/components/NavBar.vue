<template>
    <div id="app" fixed>
        <div id=" nav" class="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600
       py-4">

            <nav class="container px-6 py-2 mx-auto md:flex md:justify-between md:items-center">

                <div class="flex items-center justify-between">
                    <router-link to="/" class="font-bold text-xs text-blue-200 md:text-2xl hover:text-blue-200">
                        Countries
                    </router-link>
                    <button type="button"
                        ...
                        <router-link to="Contact"
                            ...
                            <span class="relative text-white">My list of countries</span>
                        </router-link> </button>
